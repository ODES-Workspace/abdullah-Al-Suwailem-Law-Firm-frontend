    ...
    <div ref={SELECT_REF} className={cn("relative w-full  ", className)}>
      <button
        ...
        className={cn(
          ...
          variant === "secondary" &&
            "border-b-gray py-[10px] px-3 border border-gray border-primary rounded-[14px] font-arabic-light text-primary "
        )}
      >
        ...
        >
          {options.map((option) => (
            <li
              ...
              className="h-8.5 text-lg flex items-center px-3 bg-primary-blue-2 hover:bg-primary hover:text-white"
            >
              {option.label}
            </li>
          ))}
