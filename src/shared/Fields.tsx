...
export default function Fields() {
  ...
  return (
    <>
      <style jsx global>{`
        .fields-equal-height .swiper-wrapper {
          align-items: stretch !important;
        }
        .fields-equal-height .swiper-slide {
      ...
      <div
        id="fields"
        className="py-10 px-5 bg-[linear-gradient(rgba(84,99,104,0.8),rgba(84,99,104,0.8)),url('/fields.png')] bg-no-repeat bg-cover bg-center"
      >
          ...
          <div className="w-full">
            ...
            >
              {data?.map((f: Item) => {
                ...
                return (
                  <SwiperSlide key={f.id} className="lg:!w-auto">
